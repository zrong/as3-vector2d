...
class Vector2d
{
	...
	public function set vector2d($vec:Vector2d):void
	{
		this.x = $vec.x;
		this.y = $vec.y;
	}
	...
	public function bounce($vec:Vector2d):Vector2d
	{
		//get the projection of v1 on normalized v2
		var __p1:Vector2d = this.project($vec.normalized);
		//get the normalized left hand normals of v2, and calculate the projection of v1 on it.
		var __p2:Vector2d = this.project($vec.leftNormals.normalized);
